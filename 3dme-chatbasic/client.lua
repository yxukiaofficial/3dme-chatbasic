            ...
            while isDisplaying do
                ...
                if distance < 25.0 then
                    ...
                    htmlString =
                        ...
                        xxx * 100 ..
                        "%;top: " .. yyy * 100 .. '%;"><div class="me-container"><div class="icon-container"><span style="color:#ff7100;"><i class="fas fa-'..icon..' fa-lg  "></i></span></div><div class="text-container"><b>ME: </b>' .. text .. "</div></div></span>"
                end
...
RegisterNetEvent("3dme:ooc")
AddEventHandler("3dme:ooc", function(text, source, icon)
    local playerId = GetPlayerFromServerId(source)
    if playerId ~= -1 or source == GetPlayerServerId(PlayerId()) then
        local isDisplaying = true
        liczba = liczba + 1
            ...
            while isDisplaying do
                ...
                if distance < 25.0 then
                    ...
                    htmlString =
                        ...
                        '<span style="position: absolute; left: ' ..
                        xxx * 100 ..
                        "%;top: " .. yyy * 100 .. '%;"><div class="ooc-container"><div class="icon-container"><span style="color:#0007ff;"><i class="fas fa-'..icon..' fa-lg  "></i></span></div><div class="text-container"><b>OOC: </b>' .. text .. "</div></div></span>"
                end
                if lasthtmlString ~= htmlString then
                            SendNUIMessage({
                                toggle = true,
